...
public class RuleTest {
    ...
    public void test() {
        ...
        for ( KiePackage kp : kieBase.getKiePackages() ) {
            for (Rule rule : kp.getRules()) {
                LOG.info("package '{}' rule named '{}' belongs in agenda group: {}", kp.getName(), rule.getName(), ((RuleImpl) rule).getAgendaGroup());
            }
        }
        ...
        try {
            ...
            session.getAgenda().getAgendaGroup("agroup1").setFocus();
    ...
    private KieContainer createKieContainer() {
        ...
        ReleaseId releaseId = ks.newReleaseId("org.drools.demo", "demo20230405-so75934570", "1.0-SNAPSHOT");
